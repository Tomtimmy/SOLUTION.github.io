    ...
    <div className="bg-white py-16 sm:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <header className="text-center">
          ...
          <p className="mt-4 text-lg text-dark-gray">Last Updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
        </header>
        ...
        <div className="mt-12 prose prose-lg max-w-none text-gray-700 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-dark-gray mt-8">Information We Collect</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-dark-gray mt-8">How We Use Your Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-dark-gray mt-8">Sharing Your Information</h2>
          <p>
            We do not sell, trade, or otherwise transfer to outside parties your personally identifiable information unless we provide users with advance notice. This does not include website hosting partners and other parties who assist us in operating our website, conducting our business, or serving our users, so long as those parties agree to keep this information confidential.
          </p>
          
          <h2 className="text-2xl font-bold text-dark-gray mt-8">Data Security</h2>
          <p>
            We implement a variety of security measures to maintain the safety of your personal information. Your personal information is contained behind secured networks and is only accessible by a limited number of persons who have special access rights to such systems, and are required to keep the information confidential.
          </p>

          <h2 className="text-2xl font-bold text-dark-gray mt-8">Your Rights</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-dark-gray mt-8">Changes to This Policy</h2>
          <p>
