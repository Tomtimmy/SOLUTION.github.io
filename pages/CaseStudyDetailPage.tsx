...
import { portfolioItems } from './CaseStudiesPage';
  ...
  return (
    <div className="py-16 sm:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <Link to="/portfolio" className="text-primary font-semibold hover:underline mb-8 inline-block">
          &larr; Back to Portfolio
        </Link>
        
        <header>
          <h1 className="text-4xl font-extrabold text-primary sm:text-5xl leading-tight">{project.title}</h1>
        </header>
