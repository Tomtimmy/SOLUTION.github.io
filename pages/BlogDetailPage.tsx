    ...
    <div className="bg-white">
        ...
        <div className="py-16 sm:py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
                ...
                <div className="my-8 py-4 border-y flex flex-wrap items-center gap-4">
                    <span className="font-semibold text-text-dark">Share this post:</span>
                    <div className="flex items-center gap-3">
                        <a href={twitterShareUrl} target="_blank" rel="noopener noreferrer" aria-label="Share on Twitter" className="text-gray-500 hover:text-primary transition-colors">
                        ...
                        <a href={linkedinShareUrl} target="_blank" rel="noopener noreferrer" aria-label="Share on LinkedIn" className="text-gray-500 hover:text-primary transition-colors">
                        ...
                        <a href={facebookShareUrl} target="_blank" rel="noopener noreferrer" aria-label="Share on Facebook" className="text-gray-500 hover:text-primary transition-colors">
                        ...
                        <button onClick={copyToClipboard} className="ml-2 px-3 py-1 text-sm border rounded-md hover:bg-light-bg transition-colors">
