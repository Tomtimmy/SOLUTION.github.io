    ...
    <div className="py-16 sm:py-24 bg-light-gray">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-primary sm:text-5xl">Our Services</h1>
          <p className="mt-4 text-xl text-dark-gray">Tailored solutions to drive meaningful results.</p>
        </div>
