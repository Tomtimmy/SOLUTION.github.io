                ...
                <div>
                    ...
                    <div className="mt-8 space-y-6">
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                <h3 className="text-xl font-semibold text-text-dark">Chat on WhatsApp</h3>
                                <a href="https://wa.me/2348132847661" target="_blank" rel="noopener noreferrer" className="mt-1 text-text-dark hover:text-primary transition-colors">Start a Conversation</a>
                            </div>
                        </div>
                    </div>
                </div>
