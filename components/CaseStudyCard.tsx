...
const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ id, title, description, imageUrl }) => {
  ...
  return (
    <article className="bg-light-bg rounded-lg shadow-lg flex flex-col text-left hover:shadow-xl hover:-translate-y-2 transition-all duration-300 overflow-hidden">
            ...
            {isShareOpen && (
              ...
              >
                <div className="py-1" role="none">
                  <a href={twitterShareUrl} target="_blank" rel="noopener noreferrer" className="block px-4 py-2 text-sm text-text-dark hover:bg-light-bg" role="menuitem">Share on Twitter</a>
                  <a href={linkedinShareUrl} target="_blank" rel="noopener noreferrer" className="block px-4 py-2 text-sm text-text-dark hover:bg-light-bg" role="menuitem">Share on LinkedIn</a>
                </div>
              </div>
            )}
          </div>
